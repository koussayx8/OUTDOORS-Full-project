...
// IntialState
export const initialUserState: LayoutUserState = {
...
// Reducer
export const layoutUserReducer = createReducer(
  initialUserState,
...
// Selector
export function userReducer(state: LayoutUserState | undefined, action: Action) {
    return layoutUserReducer(state, action);
}
