...
@Component({
  selector: 'app-em-eventarea-details',
  standalone: true,
  imports: [
    BsDropdownModule,
    LeafletModule,
  ...
  templateUrl: './em-eventarea-details.component.html',
  styleUrl: './em-eventarea-details.component.scss'
})
export class EmEventareaDetailsComponent implements OnInit {
